...
test:
	...
	g++ -g -o bin/tests bin/empleado_tests.o bin/horasTrabajadas.o bin/nomina.o bin/planilla.o bin/registroHora.o bin/registroPago.o bin/tipoEmpleado.o bin/horas_trabajadas_tests.o bin/nomina_tests.o bin/planilla_tests.o bin/registro_hora_tests.o bin/registro_pago_tests.o bin/tipo_empleado_tests.o -lgtest -lgtest_main -lpthread
